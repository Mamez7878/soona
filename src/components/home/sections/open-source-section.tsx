      ...
      <div className="w-full max-w-6xl mx-auto px-6">
        <SectionHeader>
          ...
          <p className="text-muted-foreground text-center text-balance font-medium">
            Soona is fully open source. Join our community and help shape the
            future of AI.
          </p>
        </SectionHeader>
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="relative">
                ...
                <p className="text-muted-foreground mt-2">
                  Explore, contribute, or fork our repository. Soona is built
              ...
              <Link
                href="https://github.com/mamez7878/soona"
                target="_blank"
