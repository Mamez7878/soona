    ...
    >
      <SectionHeader>
        ...
        <p className="text-muted-foreground text-center text-balance font-medium">
          Explore real-world examples of how Soona completes complex tasks
          autonomously
        </p>
      </SectionHeader>
                ...
                <div className="w-full h-[160px] bg-accent/10">
                  <div className="relative w-full h-full overflow-hidden">
                    <img
                      src={
                        useCase.image ||
                        `https://placehold.co/800x400/f5f5f5/666666?text=Soona+${useCase.title.split(' ').join('+')}`
                      }
                      alt={`Soona ${useCase.title}`}
