    ...
    if (projectName) {
      ...
      if (metaDescription) {
        metaDescription.setAttribute(
          'content',
          `${projectName} - Public AI conversation shared from  Soona`,
        );
      }
            ...
            <div className="flex-1">
              <div className="flex items-center gap-2">
                <div className="flex items-center justify-center w-6 h-6 rounded-md overflow-hidden bg-primary/10">
                  <Image src="/favicon.png" alt="" width={16} height={16} className="object-contain" />
                </div>
                        ...
                        >
                          <div className="flex items-start gap-3">
                            <div className="flex-shrink-0 w-5 h-5 mt-2 rounded-md flex items-center justify-center overflow-hidden bg-primary/10">
                              <Image src="/favicon.png" alt="Soona" width={14} height={14} className="object-contain" />
                            </div>
                            <div className="flex-1">
