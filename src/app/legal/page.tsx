                ...
                {activeTab === 'terms' ? (
                  <div>
                    ...
                    <ul className="text-muted-foreground space-y-1 mb-6">
                      <li>
                        "Company" refers to  AI Corp (701 Tillery Street
                        Unit 12-2521 Austin, Texas 78702, United States).
                      </li>
                      <li>
                        "Site" refers to the Soona website, including any related
                        features, content, or applications offered from time to
                        time by the Company.
                      </li>
                      <li>
                        "Service" refers to the Soona website and all related
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      Soona is licensed under the Apache License, Version 2.0.
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      ...
                      please write to legal@ai.com and we will process and
                    ...
                    <p className="text-muted-foreground text-balance mb-4">
                      ...
                      or by emailing us at legal@ai.com. If you cancel
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      All Soona logos, marks, and designations are trademarks or
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      ...
                      LIMITATION, THE Soona WEB APP AND ANY CONTENT) IS PROVIDED
                      ...
                      Soona DOES NOT GUARANTEE THE ACCURACY, COMPLETENESS, OR
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      References to our "Services" at Soona in this statement
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      Soona does not collect biometric or identifying
