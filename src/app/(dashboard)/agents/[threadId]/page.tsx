...
export default function ThreadPage({
  ...
  useEffect(() => {
    if (projectName) {
      ...
      document.title = `${projectName} |  Soona`;
      ...
      if (metaDescription) {
        metaDescription.setAttribute(
          'content',
          `${projectName} - Interactive agent conversation powered by  Soona`,
        );
      }
      ...
      if (ogTitle) {
        ogTitle.setAttribute('content', `${projectName} |  Soona`);
      }
      ...
      >
        <div className={cn('mx-auto', isMobile ? 'w-full px-4' : 'max-w-3xl')}>
          <ChatInput
            ...
            placeholder="Ask Soona anything..."
            loading={isSending}
            disabled={
              isSending ||
              agentStatus === 'running' ||
